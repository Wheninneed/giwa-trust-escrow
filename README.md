...
**64개 테스트 통과.** 명세서 15장의 항목을 모두 덮습니다.
...
| 취소 | 상호 합의 환불, 제안자 자기수락 차단, 분쟁 중 차단, 제3자 차단 |
| 관리자 | 일시정지·해제, 권한 검증, **임의 출금 함수 부재 검증** |
...
- 고객이 승인도 분쟁 제기도 하지 않고 방치하는 경우의 자동 승인 기한 규칙은 아직 없습니다.
